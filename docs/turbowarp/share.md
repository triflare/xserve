...
The best way to share your unsandboxed extension is to submit it to [extensions.turbowarp.org](https://extensions.turbowarp.org).

## Exercises

1. Explore the [TurboWarp Extension Gallery](https://github.com/TurboWarp/extensions/issues) issue tracker for inspiration.
